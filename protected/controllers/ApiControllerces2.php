...
//echo $fecha1;
$filtro2 ="id_periodo = $id_periodo and id_trimestre=$id_trim and area<>12 and partida<>211 and partida<>331 and partida<>612 ";
//$filtro .="fecha_ingreso between '$fecha1' and '$fecha2'  AND ";
...
foreach ($resultado as $row) {
		...
		$sql = "SELECT SUM(presupuesto) as suma from presupuesto where id_trimestre=$id_trim and partida=$row[partida]"; 
		$presupuesto = Yii::app()->db->createCommand($sql)->queryRow();
