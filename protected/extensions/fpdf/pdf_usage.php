...
//$fecha2 = $_POST['fecha2'];
    ...
    //    $this->Image('../img/angel.jpg', 5, 10, 30);
     ...
     //   $this->Cell(45);
       ...
       // $this->Ln(2);
        $this->Cell(5);
        $this->Cell(0, 25, utf8_decode('COORDINACIÓN DE DIFUSION CULTURAL'), 0, 0, 'L');
        $this->Ln(2);
        $this->Cell(5);

        $this->Cell(0, 30,  utf8_decode('Dirección General de Música'), 0, 0, 'L');
        //Salto de l�nea
        $this->Ln(10);

         $this->Cell(0, 30,  utf8_decode('Ejercicio Presupuestal 2014'), 0, 0, 'C');
        //Salto de l�nea
      //  $this->Ln(40);
...
WHERE 
 ...
 //ECHO $query;
   ...
   //      $this->Cell(0,4,"x",0,1,'C');
     ...
     //   $this->Cell(0,4,utf8_decode('Direccion Administrativa'),0,1,'C');//
