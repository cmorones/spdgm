...
<?php $this->widget('ext.select2.ESelect2',array(
  ...
  'data' => CHtml::listData(Subprogramas::model()->findAll('status=1'), 'id', 'nombre'),
)); ?>
</div>
<div class="span3">
...
if(isset($fecha1,$fecha2,$subprog, $id_bandera)){

//echo $subprog;
//echo $fecha2;

	if (($fecha1 != '') && ($fecha1 != '') && ($subprog != 0) && ($id_bandera != 0)) {
...
$nombandera = Yii::app()->db->createCommand($sql)->queryRow();
	...
	$titulo = "Informe detalle Subprograma por bandera del $fecha1 al $fecha2<br>$subprog[nombre]<br>$nombandera[nombre] ";
