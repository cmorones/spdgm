...
foreach ($model as $indice => $valor) {
					...
					foreach ($valor2 as $indice3 => $valor3) {
							...
							if (is_array($valor3)){
									foreach ($valor3 as $indice4 => $valor4) {
											//echo ("El indice4ces $indice4 tiene el valor: $valor4<br>");
										if (is_array($valor4)){
												foreach ($valor4 as $indice5 => $valor5) {
													//echo ("El indice5 $indice5 tiene el valor: $valor5<br>");
												
															$fecha=$model[$indice][$indice2][$indice3][$indice4][$indice5]['fecha'];
	...
	$importef=$model[$indice][$indice2][$indice3]['totalpartida'];
			$importef=number_format($importef,2);
			 echo "<tr>
	 		<td  align=\"center\"></td>
	 		<td  align=\"center\"></td>
	 		<td  align=\"center\"></td>
...
$importefinal=number_format($model[$indice]['grantotal'],2);
			 echo "<tr>
	 		<td  align=\"center\"></td>
	 		<td  align=\"center\"></td>
	 		<td  align=\"center\"></td>
