<?php
$url_action = CHtml::normalizeUrl(array('baseCap/buscar'));
//$url_action2 = CHtml::normalizeUrl(array('baseCap/admin/'.$id_periodo));  
Yii::app()->clientScript->registerScript('btn', "
     
   $(document).ready(function(){

    $('#base-cap-form').submit(function(e){
        ...
        $.ajax({
            url:'$url_action',
            type: 'POST', 
            data: {ajaxfactura: factura, ajaxprov: proveedor}
        ...
        .done(function(result){
            ...
            if (result == '1')
            {
                ...
                $.confirm({
                    theme: 'hololight',
                    title: 'Factura y proveedor ya existe!!!',
                    content: 'El sistema va duplicar este gasto??',
                ...
                document.forms['base-cap-form'].submit();
            }
        });
...
<i class="icon-reorder"></i>
 <div class="portlet-title">Agregar Gastos ejercicio <?=$anio?>
 </div>
<div class="form">
    ...
    'options'=>array(
       ...
       // 'showAnim'=>'fold',
        'select'=>"js:function(event, ui) {
            ...
            $('#clasificacion').val(ui.item.clasif);
