...
<i class="icon-reorder"></i>
 <div class="portlet-title">Informes de gastos por bandera
 </div>
<div class="form">
...
if(isset($fecha1,$fecha2, $id_bandera)){

//echo $subprog;
//echo $fecha2;

	if (($fecha1 != '') && ($fecha1 != '')  && ($id_bandera != 0)) {
  ...
  //  'condition'=>'bandera=1',
   //'condition'=>"bandera=1 and subprog=$subprog",
    'condition'=>"bandera=$id_bandera and (fecha_ingreso BETWEEN '$fecha1' AND '$fecha2')",
...
//	$subprog = Yii::app()->db->createCommand($sql)->queryRow();
		...
		$sql = "SELECT nombre  from banderas where id=$id_bandera"; 
$nombandera = Yii::app()->db->createCommand($sql)->queryRow();

	$titulo = "Informe detalle del $fecha1 al $fecha2<br>bandera:$nombandera[nombre] ";
