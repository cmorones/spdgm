...
foreach ($model as $indice => $valor) {
   //	echo ("El indice1 $indice tiene el valor: $valor<br>");
	...
	//				echo ("El indice3 $indice3 tiene el valor: $valor3<br>");
		...
		$grupo=$model[$indice][$indice2][$indice3]['grupo'];
		$subprog=$model[$indice][$indice2][$indice3]['subprog'];
		$partida=$model[$indice][$indice2][$indice3]['partida'];
		$tipo=$model[$indice][$indice2][$indice3]['tipo'];
		$area=$model[$indice][$indice2][$indice3]['area'];
		$presupuesto=number_format($model[$indice][$indice2][$indice3]['presupuesto'],2);
		$descripcion=$model[$indice][$indice2][$indice3]['descripcion'];
					echo "<tr>
