...
<i class="icon-reorder"></i>
 <div class="portlet-title">Informes detalle por Áreas
 </div>
<div class="form">
...
if(isset($fecha1,$fecha2,$id_area, $id_bandera)){

//echo $subprog;
//echo $fecha2;

	if (($fecha1 != '') && ($fecha1 != '') && ($id_area != 0) && ($id_bandera != 0)) {
   ...
   //'condition'=>"bandera=1 and subprog=$subprog",
	...
	$criteria->order = "partida,fecha_ingreso";
	...
	$titulo = "Informe detalle por Area del $fecha1 al $fecha2<br>$subprog[nombre] ";



foreach ($resultado as $key => $row) {

	   //echo $row["fecha_ingreso"] . "<br>";// 11 registros
...
$json["informe"]['sumatotal'] = $json["informe"]['sumatotal'] + $json["informe"]['partida'][$row["partida"]]['fecha_ingreso'][$row["fecha_ingreso"]]['importe'];
*/	
	}
