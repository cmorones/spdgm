...
/**
 * This is the model class for table "siau_p".
 *
 * The followings are the available columns in table 'siau_p':
 * @property integer $id
 ...
 */
class Siaup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Siaup the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('subprog, partida, id_periodo, id_trim', 'numerical', 'integerOnly'=>true),
			...
			array('id, subprog, partida, asignado, autorizado, disponible, cuentasxpagar, ejercido, ingresos_extra, fecha_reg, fecha_mod, id_periodo, id_trim', 'safe', 'on'=>'search'),
		);
	}
