...
/**
 * This is the model class for table "siau_cp".
 *
 * The followings are the available columns in table 'siau_cp':
 * @property integer $id
 ...
 */
class SiauCp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SiauCp the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('codigo, fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, codigo, asignado, autorizado, disponible, cuentasxpagar, ejercido, ingresos_extra, fecha_reg, fecha_mod', 'safe', 'on'=>'search'),
		);
	}
