...
/**
 * This is the model class for table "siau_p2".
 *
 * The followings are the available columns in table 'siau_p2':
 * @property integer $id
 ...
 */
class SiauP2 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SiauP2 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('partida', 'numerical', 'integerOnly'=>true),
			...
			array('id, partida, asignado, autorizado, disponible, cuentasxpagar, ejercido, ingresos_extra, fecha_reg, fecha_mod', 'safe', 'on'=>'search'),
		);
	}
